...
def complete_measurements_normalize_test(): # TEST MEEEE!!!!!!
     ...
     wrong = 'measuremetns_normalize_output_incorrect.out'
     fsp = file_prefix + 'measurements_normalize_specimens_weight.txt'

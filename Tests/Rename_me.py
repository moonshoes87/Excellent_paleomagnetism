...
def complete_CIT_magic_test(): # irregular
     #WD
     obj = env.run('CIT_magic.py', '-WD', file_prefix, '-f',  'CIT_magic_example.txt')
     print obj.stdout

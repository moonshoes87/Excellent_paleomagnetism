...
#          angle = Test_instance('angle.py', 'angle.dat', 'angle_results_new.out', 'angle_results_correct.txt', 'angle_results_incorrect.txt', None, False)
     curie = Test_instance('curie.py', 'curie_example.dat', 'curie_results_new.out', 'curie_results_correct.txt', 'curie_results_incorrect.txt', 'q', False)
     
def complete_plot_magic_keys_test(): # not done --- no way of saving the plot : (
#     plot_magic_keys.py -f pmag_results.txt -xkey average_age -ykey average_age_sigma
...
# below works
# plot_magic_keys.py -WD /Users/nebula/Python/Tests -f plot_magic_keys_example.dat  -F None -xkey average_age -ykey average_age_sigma None None

#below fails
#plot_magic_keys.py -WD /Users/nebula/Python/Tests -f plot_magic_keys_example.txt -F None -xkey average_age -ykey average_age_sigma
